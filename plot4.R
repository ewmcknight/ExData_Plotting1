...
#       Sub_metering_1, _2, _3 vs time between 2007-02-01 and 2007-02-02
#       Voltage vs time between 2007-02-01 and 2007-02-02
#       Global_reactive_power vs time between 2007-02-01 and 2007-02-02
...
# from plot2.R (truncating y-axis label)
plot(data$Global_active_power~data$Date_Time, type = "l",
     xlab = "",
     ylab="Global Active Power",
     main="")

# from plot3.R (removing legend border)
